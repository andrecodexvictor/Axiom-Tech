...
## Core Guides
- [Project Context and Governance](./project-context.md)
...
- `Dockerfile`
- `documentos/`
- `dotarchitecture-input.yaml`
- `dotarchitecture.yaml`
- `dotstack-project.yaml`
- `frontend/`
- `package.json`
- `pyproject.toml`
- `README.md`
...
| --- | --- | --- |
| Project Context and Governance | `project-context.md` | Domain boundaries, citations, safety rules |
